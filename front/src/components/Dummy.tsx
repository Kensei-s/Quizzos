              ...
              <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-400">
                    Utiliser une adresse sur lequel vous recevrez un mail
                  </p>
                </div>
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="mt-2">
                        <select
                          id="timezone"
                          name="timezone"
                          className="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-red-500 sm:text-sm sm:leading-6 [&_*]:text-black"
                        >
