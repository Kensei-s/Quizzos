                ...
                <div className="flex h-16 justify-between">
                      ...
                      <Link to="/dashboard">
                        ...
                        <picture className="h-8 w-auto sm:h-10">
                          <img
                            ...
                            alt="Your Company"
                            srcSet="https://tailwindui.com/img/logos/workflow-mark-red-600.svg, https://tailwindui.com/img/logos/workflow-mark-red-600.svg 1x, https://tailwindui.com/img/logos/workflow-mark-red-600.svg 2x"
                          />
                        </picture>
                      </Link>
                    </div>
                  ...
                  <div className="hidden sm:ml-6 sm:flex sm:items-center">
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
